...
{
    PushNotificationViewController *pushNotificationView = [StoryboardManager pushNotificationViewController];
    pushNotificationView.transitioningDelegate = self;
    [viewController presentViewController:pushNotificationView animated:YES completion:nil];
